...
#evaluation_data_prefix = 'data/translated-ted/valid'
#translation_prefix = "data/translated-ted/translated-pretrained"
evaluation_data_prefix = 'data/asistent-testset/asistent_testset'
translation_prefix = "data/translated-asistent/translated-pretrained"
